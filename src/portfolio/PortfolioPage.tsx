...
import { SITE, LINKS, SKILLS, LANG_COLORS } from "./data";
...
export default async function PortfolioPage() {
  ...
  const bio = profile?.bio ?? SITE.fallbackBio;
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <main className="space-y-14">
          ...
          <section>
            ...
            <h2 className="text-2xl font-semibold leading-snug tracking-tight text-white">
              ...
              <span className="text-[#666]">{SITE.tagline}</span>
            </h2>
            {bio && bio !== SITE.fallbackBio && (
      ...
      <footer className="border-t border-white/[0.06] py-7">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6">
          ...
          <a href={`mailto:${SITE.email}`} className="text-xs text-[#555] transition-colors hover:text-white">
            {SITE.email}
          </a>
        </div>
      </footer>
